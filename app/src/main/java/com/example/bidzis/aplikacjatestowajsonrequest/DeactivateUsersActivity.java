...
public class DeactivateUsersActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deactivate_users);
        final String[] elo = new String[1];
        final RequestQueue requestQueue = Volley.newRequestQueue(this);
        final JSONArray[] jsonArray = {null};
        String url1 = "http://192.168.43.84:8080/elista/uzytkownicy/pobierzPoAktywnosci/AKTYWNY";
...
//                            list.add(values[i]);
//                        }
                        final StableArrayAdapter adapter = new StableArrayAdapter(DeactivateUsersActivity.this,
                        ...
                        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                final String url2 = "http://192.168.43.84:8080/elista/uzytkownicy/usunPoId/"+aId;
                                JsonObjectRequest request3 = new JsonObjectRequest
                                        (Request.Method.PUT, url2, uzytkownik[0], new Response.Listener<JSONObject>() {
                                            ...
                                            public void onResponse(JSONObject response) {
                                                ...
                                                Toast.makeText(getApplicationContext(), "Użytkownik dezaktywowany",
                                                        Toast.LENGTH_LONG).show();
