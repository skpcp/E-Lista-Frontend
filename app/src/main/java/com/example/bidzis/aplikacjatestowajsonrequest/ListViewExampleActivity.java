...
//        final ArrayList<String> list = new ArrayList<String>();
        ...
        String url1 = "http://192.168.43.84:8080/elista/uzytkownicy/pobierzPoAktywnosci/OCZEKUJACY";
...
//                            list.add(values[i]);
//                        }
                        final StableArrayAdapter adapter = new StableArrayAdapter(ListViewExampleActivity.this,
                        ...
                        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent intent = new Intent(ListViewExampleActivity.this, AddChangeUserActivity.class);
